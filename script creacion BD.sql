...
USE [usuarios_api]
GO
/****** Object:  Table [dbo].[USUARIOS]    Script Date: 1/11/2024 6:51:50 p. m. ******/
SET ANSI_NULLS ON
GO
...
GO
ALTER TABLE [dbo].[USUARIOS] ADD  CONSTRAINT [DF_USUARIOS_CREATED]  DEFAULT (getdate()) FOR [CREATED]
GO
ALTER TABLE [dbo].[USUARIOS] ADD  CONSTRAINT [DF_USUARIOS_LAST_LOGIN]  DEFAULT (getdate()) FOR [LAST_LOGIN]
GO
ALTER TABLE [dbo].[USUARIOS] ADD  CONSTRAINT [DF_USUARIOS_ISACTIVE]  DEFAULT (N'Yes') FOR [ISACTIVE]
GO
USE [master]
GO
